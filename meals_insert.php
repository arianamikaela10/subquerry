...
if(isset($_POST['submit'])){//calling the variables from table
    ...
    $select = " SELECT * FROM meals WHERE mealid = '$mealid'";
...
<body>
   ...
   <div class="nav">
      ...
      <a class="active" href="meals_insert.php">Meals</a>
   ...
   <div class="record">
    ...
    <form action="" method="post">
        ...
        <input type="text" name="mealid" required placeholder="Meal ID">
